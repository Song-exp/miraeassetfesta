...
| `KRC` / `KRB` / `KRZ` / `XS3` | 222 / 49 / 19 / 1 | 국공채 / 회사채 / 회사채 / 외화 |
...
| 4 | 세금 산식·세후>세전 37건 (§9.4) | 🔸/🔴 미해명 | 원본 정의 필요 |
| 5 | 개인투자용국채 장외 이유 (§9.5) | 🔸 추정 | 도메인 자료 확인 |
| 6 | 🆕 만기 도래분 `EVAL_PRICE = 10000.0` 일괄 파킹 의심 | 🔴 103건 확인, 전수 미확인 | 만기 도래 11,101건 전체 스윕 (노트 §D.15 부수 발견 ②) |
| 7 | 🆕 통안증권 할인형/이표형 구분 기준 | 🔸 2년물 이표형 추정 | `DC` 접두 여부 대조 (노트 §D.15 부수 발견 ③) |
...
| 4 | 🟡 **발행사 개수 8,018 vs 8,015** — 두 문서가 다름 | 정규화·결측 처리 차이로 보이나 미확인 |
