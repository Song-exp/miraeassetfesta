...
**선언이 붙은 데이터 결함은 이 6건이 전부가 아니다** — 채권 하나에 `query_rules` 40 · `answer_rules` 21 · 결정층 가드 19가 붙어 있고, 그중 아래 6건이 이야기하는 것은 가드 3개다. 나머지는 자리를 아껴 부록·발췌로 보냈고, 무엇을 왜 뺐는지 여기 밝힌다(전수 대조 2026-09-04).
