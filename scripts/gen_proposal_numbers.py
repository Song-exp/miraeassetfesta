...
n_mat_null, n_mat_zero = b("mat_dt IS NULL"), b("mat_dt = 0")
...
L.append(f"| ⑤ | 센티넬·위장 결측 | `avg_annual_tax_yield` 0·NULL {n_tax0:,}(전량) · `curr_cd`='000' {n_cur000:,} · `dur`≥90 {n_dur99:,} · `mat_dt` 결측 {n_mat0:,}(NULL {n_mat_null:,} + 0 센티넬 {n_mat_zero:,}) | 전량 0 · 99 · 99991231 | `zero_as_missing` 11컬럼 · 게이트 `curr_cd` 상수 · 규칙 `외화채없음` |")
